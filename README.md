# custom nwjs download url with nw-builder @ 3.5.7

```js
downloadUrl: process.env.npm_config_nwjs_builder_urlbase || process.env.NWJS_BUILDER_URLBASE || 'https://npm.taobao.org/mirrors/nwjs/',
```
### In your project .npmrc
nwjs_builder_urlbase=https://npm.taobao.org/mirrors/nwjs/
